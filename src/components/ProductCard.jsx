...
const ProductCard = ({ data, dispatch, setIsCartOpen }) => {
  ...
  return (
    ...
    >
      <div className="relative flex items-center justify-center w-full h-60 bg-gray-200">
        <img
      ...
      <div className="p-3 sm:p-4">
        ...
        <div className="flex flex-row items-center justify-between">
          <span className="text-gray-900 font-bold text-base sm:text-lg mb-2 sm:mb-0">
            ₹{data.currentPrice}
          </span>
