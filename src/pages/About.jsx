...
const About = () => {
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-t from-rose-gold via-rose-gold-light to-pearlescent-white p-6 md:p-12">
      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-16 items-center my-16">
        <Slide triggerOnce direction="left">
          <div>
            <h2 className="font-montserrat font-bold text-3xl text-gray-800 mb-4">💫 From Dull to Dazzling — Instantly with Ozil</h2>
        ...
        <Slide triggerOnce direction="right">
          <div className="flex justify-center">
            ...
            <div className="w-80 h-80 bg-rose-gold-light rounded-full shadow-neumorphic flex items-center justify-center">
              <span className="font-cinzel text-white text-4xl">OZIL</span>
            </div>
          </div>
        </Slide>
      </div>
      ...
      <div className="container mx-auto text-center my-16">
        <Fade triggerOnce>
          <h2 className="font-montserrat font-bold text-3xl text-gray-800 mb-8">💖 What Sets Us Apart?</h2>
        </Fade>
      ...
      <div className="container mx-auto text-center my-16 max-w-3xl">
        <Fade triggerOnce>
          ...
          <p className="font-poppins text-lg text-gray-700 mt-4">
