...
const Affiliate = () => {
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-t from-rose-gold via-rose-gold-light to-pearlescent-white p-4 sm:p-6 md:p-12">
      ...
      <div className="container mx-auto my-12 sm:my-16">
        <Slide triggerOnce direction="up">
          <p className="font-poppins text-base sm:text-lg text-gray-600 text-center max-w-4xl mx-auto">
      ...
      <div className="container mx-auto text-center my-12 sm:my-16">
        <Fade triggerOnce>
          <h2 className="font-montserrat font-bold text-2xl sm:text-3xl text-gray-800 mb-8">🎯 Why Join?</h2>
        </Fade>
      ...
      <div className="container mx-auto text-center my-12 sm:my-16">
        <Fade triggerOnce>
          <h2 className="font-montserrat font-bold text-2xl sm:text-3xl text-gray-800 mb-8">👇 How It Works</h2>
        </Fade>
      ...
      <div className="container mx-auto text-center my-12 sm:my-16">
        <Fade triggerOnce>
          <p className="font-poppins text-base sm:text-lg text-gray-700 mb-8">
            Whether you blog, vlog, or just post on Instagram, you can start earning today.
          </p>
          <a href="/" className="bg-secondary text-white font-bold py-3 px-6 sm:py-4 sm:px-8 rounded-full transition duration-300 shadow-md hover:shadow-lg transform hover:scale-105 text-sm sm:text-base">
